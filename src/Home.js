                ...
                <div className="w-[90%] md:w-[75%] lg:w-full lg:flex-[40%] h-[80%] md:h-[85%] lg:h-full border-2 border-secondary lg:border-none lg:border-l-2 relative"> 
                    ...
                    <div className="w-full h-full z-50 relative flex flex-col items-center justify-center p-[1rem]">
                        ...
                        <ul className=" w-fit h-full flex flex-col ml-[2rem]"> 
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-start items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Newhall</li> { /* fix this with proper links later */}
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-start items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Castaic</li>
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-start items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Valencia</li>
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-start items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Stevenson Ranch</li>
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-start items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Antelope Valley</li>
                            <li className="text-[1.6rem] md:text-[2rem]  flex justify-end items-center flex-auto"><span className="border border-thirdarylol w-[1.5rem] mr-[.5rem]"></span>Surrounding Valleys</li>
                        </ul>
                        </div>
                    </div>
                </div>
