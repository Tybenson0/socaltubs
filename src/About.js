    ...
    return (
        <div className="w-full h-fit bg-thirdarylol flex flex-col items-center">
            <div className="w-full h-fit  pt-[10rem] lg:pt-[4rem] flex flex-col items-center">
                <h2 className=" text-4xl md:text-[2.4rem] lg:text-[3.2rem] leading-[2.6rem] lg:leading-[4rem] w-[80%] md-w-[75%] lg:w-[50%] text-center">
                    "The Pinnacle of Bathing Luxury in Southern California and Beyond"
                </h2>
                <h2 className='opacity-[70%] w-[50%] text-center mt-[.5rem] text-[1.2rem] lg:text-[1.6rem]'>Top Rated vanity and tub service in Santa Clarita Valley</h2>
            ...
            <div className='flex flex-col items-center lg:flex-[60%] lg:h-[90%] overflow-hidden'>
            <p className="w-[95%] md:w-[90%] text-[1.2rem] lg:text-[1.2rem] leading-10 lg:leading-8 text-center indent-4 lg:mt-[0] mt-8 ">
            ...
            <p className="w-[95%] md:w-[90%] text-[1.2rem] lg:text-[1.2rem] leading-10 lg:leading-8 text-center indent-8  mt-4">
